...
if __name__ == '__main__':
    ...
    # Merge the pre-trained weights from Stage 1:
    parser.add_argument('--stage1_path', type=str, required=False, default='./stage1_MSC/last.ckpt')
    parser.add_argument('--input_path', type=str, required=False, default='./stage1_Unet/last.ckpt')
    parser.add_argument('--output_path', type=str, required=False, default='ckpt_for_stage2.ckpt')
